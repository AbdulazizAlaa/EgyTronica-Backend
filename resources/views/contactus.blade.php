...
<head>
    ...
    <title>EgyTronica Contact Form</title>
    ...
    <link rel="stylesheet" href="{{ url('/res/css/app.css') }}">

    <link rel="icon" type="image/x-icon" href="{{ url('res/img/icon1.ico') }}" >
    <link rel="icon" type="image/png" href="{{ url('res/img/icon.png') }}" sizes="16x16">

    <!-- Bootstrap Core -->
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" />
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.5/css/bootstrap.min.css" integrity="sha384-AysaV+vQoT3kOAXZkl02PThvDr8HYKPZhNT5h/CXfBThSRXQ6jW5DO2ekP5ViFdi" crossorigin="anonymous" />
    <link href="{{ url('res/style.css') }}" rel="stylesheet">
            ...
            <div class="row">
                <div class="col-md-3">
                    <a class="navbar-brand">
                        <img class="logo img-fluid" src="{{ url('/res/img/logo.png') }}">
                    </a>
                </div>
